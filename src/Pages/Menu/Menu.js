...
import yummyheader6 from "../../Images/yummyheader6.png";
...
export default function Menu() {
    ...
    const { regNo } = useContext(RegNoContext);
    ...
    return (
        <div className="outer-container">
            <div className="container">
                <Navbar className="navbarcus"/>
                <Jumbotron title={stallName} tagLine="............" backgroundImage={yummyheader6} />
                <Tabs defaultActiveKey="menu" id="yummy-tabs" className="mb-3">
                    <Tab eventKey="menu" title="Menu">
                        <div className="row">
                            {menuItems.map(item => (
                                <div className="col-md-6" key={item.item_name}>
                                    <MenuItem
